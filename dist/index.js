...
var S=require('@stdlib/assert-is-wasm-memory/dist'),q=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),g=require('@stdlib/utils-inherit/dist'),m=require('@stdlib/wasm-module-wrapper/dist'),j=require('@stdlib/error-tools-fmtprodmsg/dist'),z=y();function s(e){if(!(this instanceof s))return new s(e);if(!S(e))throw new TypeError(j('29jH0',e));return m.call(this,z,e,{env:{memory:e}}),this}g(s,m);q(s.prototype,"main",function(r,i,a,t){return this._instance.exports.stdlib_strided_dapxsumpw(r,i,a,t)});q(s.prototype,"ndarray",function(r,i,a,t,p){return this._instance.exports.stdlib_strided_dapxsumpw_ndarray(r,i,a,t,p)});f.exports=s
